...
JAZZMIN_SETTINGS = {
    "site_title": "Show API Admin",
    "site_header": "Show API",
    "site_brand": "Show API",
...
# Для реального отправления через Gmail
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = config('EMAIL_USER')  # в .env
EMAIL_HOST_PASSWORD = config('EMAIL_PASS')  # в .env
